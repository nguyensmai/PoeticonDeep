...
epsilonw_0      = 0.005;   % Learning rate for weights 
epsilonvb_0     = 0.005;   % Learning rate for biases of visible units 
epsilonhb_0     = 0.005;   % Learning rate for biases of hidden units 
