...
for epoch = epoch:maxepoch
    ...
    if time>5,
        ...
        epsilonwv     = epsilonwv1/(numCDiters*log2(epoch));   % Learning rate for weights between th
        epsilonwl     = epsilonwl1/(numCDiters*log2(epoch));   % Learning rate for weights between th
        epsilontb     = epsilontb1/(numCDiters*log2(epoch));   % Learning rate for biases of top unit
        epsilonhb     = epsilonhb1/(numCDiters*log2(epoch));   % Learning rate for biases of hidden u
        epsilonlb     = epsilonlb1/(numCDiters*log2(epoch));   % Learning rate for biases of label un
        
    else
        momentum=initialmomentum;
        epsilonwv     = epsilonwv1/(1.0*numCDiters);   % Learning rate for weights between the top an
        epsilonwl     = epsilonwl1/(1.0*numCDiters);   % Learning rate for weights between the top an
...
%         end
    ...
    if mod(epoch,50)==1 || epoch==maxepoch
